...
#ifndef NL_KINGSQUARE_CORDOVA_BACKGROUNDAUDIO_SWIFT_H
#define NL_KINGSQUARE_CORDOVA_BACKGROUNDAUDIO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Nl_kingsquare_cordova_backgroundAudio",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
